...
#ifndef Connect4_BluePiece_h
#define Connect4_BluePiece_h
...
class BluePiece: public GamePiece {
private:
  // members
...
public:
  // ctor
  BluePiece(const float & = 0, const float & = 0, const float & = 40);
  
  // copy ctor
  BluePiece(const BluePiece &);
